...
#define emailSenderAccount    "binus.aso.iot@gmail.com"
#define emailSenderPassword   "qilh fraq onxn lpbc"
#define smtpServer            "smtp.gmail.com"
#define smtpServerPort        465
#define emailSubject          "[PERINGATAN] Parameter Hidroponik"

// Default Recipient Email Address
String inputMessage = "nicholassanjaya339@gmail.com";
String enableEmailChecked = "checked";
String inputMessage2 = "true";
// Default Threshold temperatur air Value
//String threstemp = "25.0";
//String lastTemperature;
//// Default Threshold jarak air Value
//String threshum = "25.0";
//String lastHumidity;
...
void loop() {
  ...
  if(temperature < settingTemp && inputMessage2 == "true" && !emailSent){
    ...
    else if(r < settingPPM && inputMessage2 == "true" && !emailSent) {
